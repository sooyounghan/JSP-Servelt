                ...
                <div class="sub-menu">
                    ...
                    <nav id="member-menu" class="linear-layout">
                        ...
                        <ul class="linear-layout">
                            ...
                            <li><a href="/Project/notice/list.html"><img src="/Project/images/txt-customer.png" alt="고객센터" /></a></li>
                        </ul>
                    </nav>
		...
		<div class="content-container clearfix">
			...
			<aside class="aside">				
				...
				<nav class="menu text-menu first margin-top">
					...
					<ul>
						<li><a href="/Project/member/login.jsp">로그인</a></li>
						<li><a href="/Project/member/join.jsp">회원가입</a></li>
						<li><a href="v/member/">아이디찾기</a></li>
						<li><a href="/Project/member/t">비밀번호 재발급</a></li>
					</ul>
				</nav>
		...
		<ul>
            ...
            <main>
                ...
                <div class="breadcrumb" style="margin-top:-20px;">
                    ...
                    <img src="/Project/images/member/step3.png" alt="회원가입 3단계" />
                </div>
                
                <div class="margin-top first" style="background: url('/Project/images/member/bg-login.png') no-repeat center;height: 277px;">
                    <div class="text-align-center">
                        <img style="margin-left:170px; margin-top:70px;" alt="뉴렉처의 회원가입이 완료되었습니다." src="/Project/images/member/txt-join-welcome.png">
                    </div>
                    <div class="text-align-center">
                        <a class="btn" style="margin-left:170px; margin-top:50px;display:inline-block;width:83px;height: 53px;background: url('/Project/images/member/btn-login.png') no-repeat center;" href="login.html">메인페이지로 이동합니다.</a>
                    </div>
                </div>
            </main>
