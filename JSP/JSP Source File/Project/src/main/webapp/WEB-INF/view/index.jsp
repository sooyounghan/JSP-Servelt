...
<head>
    ...
    <link href="/Project/css/layout.css" type="text/css" rel="stylesheet" />
    <link href="/Project/css/index.css" type="text/css" rel="stylesheet" />
</head>
    ...
    <div id="visual" class="">
        <div class="content-container">
            ...
            <ul class="banner">
                ...
                <li class="banner1">
                    <a href="/Project/customer/event/1">
                        <img src="/Project/admin/board/event/1/banner-java.png" data-id="1" style="cursor: pointer;" />
                    </a>
                </li>
        ...
        <div class="content-container">
            <section class="guide">
                ...
                <div class="margin-top">
                    <a href="/Project/customer/faq/1"><img src="/Project/images/customer/installInfo.png" /></a>
                </div>
                <!-- <div>
            2
            </div>
                ...
                <ul class="list margin-top">
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="/Project/notice/detail.jsp">스프링 8강까지의 예제 코드</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="/Project/notice/detail.jsp">스프링 DI 예제 코드</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="/Project/notice/detail.jsp">뉴렉쌤 9월 초 국기과정 모집 안내</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="/Project/notice/detail.jsp">뉴렉처 강의 수강 방식 안내</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="/Project/notice/detail.jsp">자바 구조적인 프로그래밍 강의 예제 파일</a>
                        </span>
    ...
    <main id="course">
        <section class="content-container list list-horizontal list-course list-course-index">
            ...
            <ul>
                ...
                <li class="item-course normal event">
                    <div>
                        <a href="/Project/course/2"><img src="/Project/images/course/java.png" /></a>                        
                    </div>
                    <div>
                        <div>
                            <a href="/Project/course/2"><span class="text-strong text-ellipsis">자바 프로그래밍</span></a>
                        </div>
                        <div class="price">
                            <span class="normal deprecated">
                                <span class="text-gray">
