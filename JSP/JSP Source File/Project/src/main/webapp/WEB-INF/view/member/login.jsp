...
<head>
    ...
    <link href="/Project/css/member/layout.css" type="text/css" rel="stylesheet" />
    <style>
...
<script src="/Project/resource/js/header.js"></script>
	<!-- --------------------------- <visual> --------------------------------------- -->
	<!-- visual 부분 -->
			...
			<aside class="aside">				
				...
				<nav class="menu text-menu first margin-top">
					...
					<ul>
						...
						<li><a href="/Project/member/">아이디찾기</a></li>
                ...
                <div class="margin-top first">
                    ...
                    <form class="login-form" method="post">
                        <fieldset>
                            ...
                            <h4>
                                <img src="/Project/images/member/txt-title.png" />
                            </h4>
                            <ul class="login-box">
                                <li>
